...
?>
                ...
                <div class="row">
                            ...
                            <div class="panel-body table-responsive">
                                <div class="box-tools m-b-15">
                                    <form action="anggota.php" method="POST">
                                        <div class="input-group">
                                            <input type='text' class="form-control input-sm pull-right" style="width: 150px;" name='qcari' placeholder='Cari' required />
	               ...
	               or nama like '%$qcari%'  ";
                        ...
                        <div class="text-right" style="margin-top: 10px;">
                            <a href="anggota.php" class="btn btn-sm btn-info">Refresh Anggota <i class="fa fa-refresh"></i>
                        </div>
                        </div><!-- /.box-body -->
                    </div><!-- /.box -->
                </div>
    ...
    <div class="footer-main">
        Copyright Perpustakaan Kita | Repost by Kelompok6
    </div>
    </aside><!-- /.right-side -->
