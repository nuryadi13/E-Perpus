                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <span><?php echo  $player ?> <i class="caret"></i></span>
                            </a>
        ...
        <aside class="left-side sidebar-offcanvas">
            ...
            <section class="sidebar">
                ...
                <!-- <div class="user-panel">
                    <div>
                        <center><img src="
                        //<?php echo $_SESSION['foto']; ?>" height="80" width="80" class="img-circle" alt="Foto Anggota" style="border: 3px solid white;" /></center>
                    </div>
                    <div class="info">
                        <center>
